...
export const ChatUI: FC<ChatUIProps> = ({}) => {
  ...
  return (
    <div className="relative flex h-full flex-col items-center">
      ...
      <div className="absolute bottom-4 right-4 flex h-[40px] items-center space-x-2">
        <button
          className="flex size-9 items-center justify-center rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700"
